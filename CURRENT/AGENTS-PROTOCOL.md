---
type: runbook
title: "Protocolo Agentes — Valdhran"
...
# AGENTS-PROTOCOL — Valdhran

> Perplexity debate y genera prompts. Claude Code ejecuta; nunca decide.

## Contexto del proyecto
ERP open-source multi-tenant. Cada empresa aislada en schema PostgreSQL propio. Rust idiomático + sqlx compile-time checks.

## Orden de lectura obligatorio al iniciar sesión
1. STATUS.md — alertas activas
2. DECISIONS.md — últimas 5 DECs
3. ARCHITECTURE.md — stack Rust + Axum + PostgreSQL schema-per-tenant + Docker
